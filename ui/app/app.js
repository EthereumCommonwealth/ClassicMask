...
App.prototype.render = function() {
  ...
  const isLoadingNetwork =
    network === 'loading' && props.currentView.name !== 'config'
  const loadMessage =
...
App.prototype.renderAppBar = function() {
  ...
  return h(
    ...
    [
      h(
        '.app-header.flex-row.flex-space-between',
        {
          style: {
            alignItems: 'center',
    ...
    Dropdown,
    {
      ...
      onClickOutside: event => {
        ...
        const isToggleElement =
          classList.contains('sandwich-expando') ||
    ...
    [
      ...
      h(
        DropdownMenuItem,
        {
          closeMenu: () => this.setState({ isMainMenuOpen: !isOpen }),
          onClick: () => {
            this.props.dispatch(actions.showInfoPage())
          },
        },
        'Info/Help'
      )
...
App.prototype.renderPrimary = function() {
  ...
  if (!props.noActiveNotices) {
    ...
    return h(NoticeScreen, {
      ...
      key: 'NoticeScreen',
      onConfirm: () =>
        props.dispatch(actions.markNoticeRead(props.lastUnreadNotice)),
    })
  ...
  switch (rpcTarget) {
    ...
    default:
      return h(
        ...
        [h('i.fa.fa-question-circle.fa-lg.menu-icon'), label, h('.check', '✓')]
      )
  }
}
